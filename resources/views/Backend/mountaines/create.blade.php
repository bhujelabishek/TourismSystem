    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h4 style="color: green;">Create Mountaines</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('mountaines.store') }}" enctype="multipart/form-data">
                    {{-- CSRF Token --}}
                    @csrf
                    ...
                    <button type="submit" style="float: right;" class="btn btn-primary">Add Mountaines</button>
</body>
@endsection
